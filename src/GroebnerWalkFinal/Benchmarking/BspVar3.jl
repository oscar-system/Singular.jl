...
function benchmarkVar3()
    ...
    push!(
        ...
        Singular.Ideal(
            R,
            [
                48 * a * c + 19 * a * c^2 + 23 * a^3 * b^2 + 42 * a * b^2 * c^2,
                18 * b^2 +
                32 * a^2 * b +
                64 * b * c^2 +
                44 * a * b^3 +
