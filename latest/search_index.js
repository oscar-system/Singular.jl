...
{
    "location": "integer.html#AbstractAlgebra.Generic.isunit-Tuple{n_Z}",
    "page": "Integers",
...
{
    "location": "integer.html#Base.denominator-Tuple{n_Z}",
    "page": "Integers",
...
{
    "location": "integer.html#Base.numerator-Tuple{n_Z}",
    "page": "Integers",
...
{
    "location": "integer.html#Base.abs-Tuple{n_Z}",
    "page": "Integers",
    "title": "Base.abs",
    "category": "method",
...
{
    "location": "rational.html#Base.numerator-Tuple{n_Q}",
    "page": "Rational field",
    "title": "Base.numerator",
    "category": "method",
...
{
    "location": "rational.html#Base.denominator-Tuple{n_Q}",
    "page": "Rational field",
    "title": "Base.denominator",
    "category": "method",
...
{
    "location": "rational.html#Base.abs-Tuple{n_Q}",
    "page": "Rational field",
    "title": "Base.abs",
    "category": "method",
...
{
    "location": "rational.html#Nemo.reconstruct-Tuple{n_Z,n_Z}",
    "page": "Rational field",
...
{
    "location": "modn.html#AbstractAlgebra.Generic.isunit-Tuple{n_Zn}",
    "page": "Integers mod n",
    "title": "AbstractAlgebra.Generic.isunit",
    "category": "method",
...
{
    "location": "modn.html#AbstractAlgebra.Generic.characteristic-Tuple{N_ZnRing}",
    "page": "Integers mod n",
...

{
    ...
    "title": "Integers mod p",
    "category": "section",
    "text": "Integers mod a prime p are implemented via the Singular n_Zp type for any positive prime modulus less than 2^29.The associated field of integers mod p is represented by a parent object which can be constructed by a call to the Fp constructor.The types of the parent objects and elements of the associated fields of integers modulo p are given in the following table according to the library providing them.Library Element type Parent type\nSingular n_Zp Singular.N_ZpFieldAll integer mod p element types belong directly to the abstract type FieldElem and all the parent object types belong to the abstract type Field."
},
...
{
    "location": "modp.html#AbstractAlgebra.Generic.characteristic-Tuple{N_ZpField}",
    "page": "Integers mod p",
    "title": "AbstractAlgebra.Generic.characteristic",
    "category": "method",
...
{
    "location": "GF.html#AbstractAlgebra.Generic.degree-Tuple{N_GField}",
    "page": "Finite fields",
...
{
    "location": "GF.html#AbstractAlgebra.Generic.characteristic-Tuple{N_GField}",
    "page": "Finite fields",
    "title": "AbstractAlgebra.Generic.characteristic",
    "category": "method",
...
{
    "location": "GF.html#AbstractAlgebra.Generic.isunit-Tuple{n_GF}",
    "page": "Finite fields",
    "title": "AbstractAlgebra.Generic.isunit",
    "category": "method",
    "text": "isunit(n::n_GF)\n\nReturn true if n is a unit in the field, i.e. nonzero.\n\n\n\n"
...

{
    ...
    "title": "Basic manipulation",
    "category": "section",
    "text": "Singular.degree(::N_GField)Singular.characteristic(::N_GField)isunit(::n_GF)ExamplesR,w = FiniteField(7, 2, \"w\")\nw^48 == 1\na = R(5)\n\nisunit(a)\nc = characteristic(R)\nd = degree(R)"
},
...

{
    ...
    "title": "Constructors",
    "category": "section",
    "text": "PolynomialRing(R::Union{Ring, Field}, s::Array{String, 1};\n   cached::Bool = true, ordering::Symbol = :degrevlex,\n      ordering2::Symbol = :comp1min, degree_bound::Int = 0)Returns a tuple, S x consisting of a multivariate polynomial ring S and an array x of variables (from which polynomials can be constructed). The ring R must be a valid Singular coefficient ring, or any Nemo/AbstractAlgebra coefficient ring. The array s must be a list of strings corresponding to how the variables will be printed. By default, there will only be one Singular polynomial ring in the system for each combination of coefficient ring, list of variable names, ordering and degree bound. This is accomplished by making use of a global cache. If this is not the desired behaviour, false can be passed to the optional argument cached. Two orderings can be specified, one for term ordering of the polynomials, and another for ordering of module components. They can occur in either order, the first taking precedence over the other, when the polynomials are used to represent module generators. If either is not specified, the indicated default is used.The options for polynomial term ordering are the symbols, :lex, :deglex, :degrevlex, :neglex, :negdeglex and :negdegrevlex, and the options for module component ordering are comp1min and comp1max.If one has an a priori bound on the degree in each variable of a polynomial (including for all intermediate computations in this ring), one can specify it using the degree_bound optional parameter. Singular may then be able to use a more efficient representation internally, which will use less memory and allow for faster arithmetic. By default, Singular uses a bound of 16 bits internally for the exponent of each variable, however this is a signed value, so that the default is for nonnegative exponents that fit in 15 bits.Note that internally, Singular may use a higher bound than specified, if it will not increase the amount of storage required.ExamplesR, (x, y, z) = PolynomialRing(ZZ, [\"x\", \"y\", \"z\"])\n\nS, vars = PolynomialRing(QQ, [\"x\", \"y\"]; ordering=:deglex)\n\nT, x = PolynomialRing(ZZ, [\"x$i\" for i in 1:5];\n       ordering=:comp1max, ordering2=:degrevlex, degree_bound=5)See also the convenience macros below for simple use cases.The following function allows creating a Singular polynomial ring from a given polynomial ring of type AbstractAlgebra.Generic.MPolyRing:PolynomialRing(R::AbstractAlgebra.Generic.MPolyRing{T}; cached::Bool = true, ordering::Symbol = :degrevlex, ordering2::Symbol = :comp1min, degree_bound::Int = 0)  where {T <: RingElement}Polynomials can be constructed using arithmetic operations on the generators, but this can be extremely inefficient. For this purpose, Singular polynomials support construction using a build context, as described in the AbstractAlgebra documentation:https://nemocas.github.io/AbstractAlgebra.jl/mpolynomial_rings.htmlExamplesR, (x, y) = PolynomialRing(ZZ, [\"x\", \"y\"])\nC = MPolyBuildCtx(R)\n\npush_term!(C, ZZ(1), [1, 2])\npush_term!(C, ZZ(3), [1, 1])\npush_term!(C, -ZZ(1), [0, 1])\nf = finish(C)"
},
...
{
    "location": "polynomial.html#AbstractAlgebra.Generic.nvars-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
    "title": "AbstractAlgebra.Generic.nvars",
    "category": "method",
    "text": "nvars(R::PolyRing)\n\nReturn the number of variables in the given polynomial ring.\n\n\n\n"
},

{
    "location": "polynomial.html#AbstractAlgebra.Generic.symbols-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
    "title": "AbstractAlgebra.Generic.symbols",
    "category": "method",
    "text": "symbols(R::PolyRing)\n\nReturn symbols for the generators of the polynomial ring R.\n\n\n\n"
},

{
    "location": "polynomial.html#Singular.has_global_ordering-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
...
{
    "location": "polynomial.html#Singular.has_mixed_ordering-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
    "title": "Singular.has_mixed_ordering",
    "category": "method",
    "text": "has_mixed_ordering(R::PolyRing)\n\nReturn true if the given ring has a mixed ordering, i.e. if 1  x_i for a variable x_i and 1x_j for another variable x_j.\n\n\n\n"
},

{
    "location": "polynomial.html#Singular.has_local_ordering-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
    "title": "Singular.has_local_ordering",
    "category": "method",
    "text": "has_local_ordering(R::PolyRing)\n\nReturn true if the given ring has a local ordering, i.e. if 1  x for all variables x.\n\n\n\n"
},

{
    "location": "polynomial.html#AbstractAlgebra.Generic.characteristic-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
    "title": "AbstractAlgebra.Generic.characteristic",
    "category": "method",
...
{
    "location": "polynomial.html#Singular.degree_bound-Tuple{PolyRing}",
    "page": "Multivariate polynomials",
...
{
    "location": "polynomial.html#Singular.lead_exponent-Tuple{spoly}",
    "page": "Multivariate polynomials",
...
{
    "location": "polynomial.html#Singular.order-Tuple{spoly}",
    "page": "Multivariate polynomials",
    "title": "Singular.order",
    "category": "method",
...

{
    ...
    "title": "Basic manipulation",
    "category": "section",
    "text": "nvars(::PolyRing)symbols(::PolyRing)has_global_ordering(R::PolyRing)has_mixed_ordering(R::PolyRing)has_local_ordering(R::PolyRing)Singular.characteristic(R::PolyRing)degree_bound(R::PolyRing)lead_exponent(p::spoly)total_degree(p::spoly)order(p::spoly)ExamplesR = @PolynomialRing(ZZ, \"x\", 3)\n\nn = ngens(R)\nhas_global_ordering(R) == true\nc = characteristic(R)\nL = degree_bound(R)\nexps = lead_exponent(x1*x2 + 3x1*x2^2 + x3 + 2)\ndeg = total_degree(x1*x2 + 3x1*x2^2 + x3 + 2)\nord = order(x1*x2 + 3x1*x2^2 + x3 + 2) "
},

{
    "location": "polynomial.html#AbstractAlgebra.Generic.primpart-Tuple{spoly}",
    "page": "Multivariate polynomials",
...
{
    "location": "polynomial.html#AbstractAlgebra.Generic.content-Tuple{spoly}",
    "page": "Multivariate polynomials",
...
{
    "location": "polynomial.html#Singular.factor_squarefree-Tuple{spoly}",
    "page": "Multivariate polynomials",
    "title": "Singular.factor_squarefree",
    "category": "method",
    "text": "factor_squarefree(x::spoly)\n\nReturns a squarefree factorization of x.\n\n\n\n"
},

{
    "location": "polynomial.html#Singular.factor-Tuple{spoly}",
    "page": "Multivariate polynomials",
    "title": "Singular.factor",
    "category": "method",
    "text": "factor(x::spoly)\n\nReturns the factorization of x.\n\n\n\n"
},

{
    "location": "polynomial.html#Multivariate-Factorisation-1",
    "page": "Multivariate polynomials",
    "title": "Multivariate Factorisation",
    "category": "section",
    "text": "For the Singular base fields QQ and Fp a function to compute a  squarefree factorization is available.Singular.factor_squarefree(p::spoly)ExamplesR = @PolynomialRing(QQ, \"x\", 4)\n\nf = 123*(57*x2^3 + x4^5)^3*(x1^2 + x1+1)^2*(x1 + x2*x3)^2\n\nFac = factor(f)For the Singular base rings QQ, ZZ and Fp a function to compute the multivariate factorization is available.Singular.factor(p::spoly)ExamplesR = @PolynomialRing(ZZ, \"x\", 4)\n\nf = 123*(57*x2^3 + x4^5)^3*(x1^2 + x1+1)^2*(x1 + x2*x3)^2\n\nFac = factor(f)"
},

{
    "location": "polynomial.html#Singular.AsEquivalentSingularPolynomialRing-Union{Tuple{MPolyRing{T}}, Tuple{T}} where T<:AbstractAlgebra.RingElem",
    "page": "Multivariate polynomials",
    "title": "Singular.AsEquivalentSingularPolynomialRing",
    "category": "method",
    "text": "AsEquivalentSingularPolynomialRing(R::AbstractAlgebra.Generic.MPolyRing{T}; cached::Bool = true,\n  ordering::Symbol = :degrevlex, ordering2::Symbol = :comp1min,\n  degree_bound::Int = 0)  where {T <: RingElem}\n\nReturn a Singular (multivariate) polynomial ring over the base ring of R in variables having the same names as those of R.\n\n\n\n"
},

{
    "location": "polynomial.html#Singular.AsEquivalentAbstractAlgebraPolynomialRing-Union{Tuple{PolyRing{n_unknown{T}}}, Tuple{T}} where T<:AbstractAlgebra.RingElem",
    "page": "Multivariate polynomials",
    "title": "Singular.AsEquivalentAbstractAlgebraPolynomialRing",
    "category": "method",
...
{
    "location": "polynomial.html#Conversion-between-Singular.jl-polynomials-and-MPoly-polynomials-1",
    "page": "Multivariate polynomials",
    "title": "Conversion between Singular.jl polynomials and MPoly polynomials",
    "category": "section",
    "text": "There are conversion functions between the polynomial ring implementation from Singular.jl and the generic MPoly implementation from AbstractAlgebra.jl.AsEquivalentSingularPolynomialRing(R::AbstractAlgebra.Generic.MPolyRing{T}; cached::Bool = true,\n      ordering::Symbol = :degrevlex, ordering2::Symbol = :comp1min,\n      degree_bound::Int = 0)  where {T <: RingElem}AsEquivalentAbstractAlgebraPolynomialRing(R::Singular.PolyRing{Singular.n_unknown{T}}; ordering::Symbol = :degrevlex)  where {T <: Nemo.RingElem}ExamplesConversion of generic AbstractAlgebra polynomials to Singular.jl polynomials:K = Nemo.ZZ\nR, (x, y) = AbstractAlgebra.Generic.PolynomialRing(K, [\"x\", \"y\"]);\nRsing, vars_Rsing = Singular.AsEquivalentSingularPolynomialRing(R);\nRsing(x + y) == Rsing(x) + Rsing(y)Conversion of Singular.jl polynomials to generic AbstractAlgebra polynomials:K = Nemo.ZZ\nS, (u, v) = Singular.PolynomialRing(K, [\"u\", \"v\"])\nSaa, (uu, vv) = Singular.AsEquivalentAbstractAlgebraPolynomialRing(S)\nSaa(u) + Saa(v) == Saa(u) + Saa(v)"
},
...
{
    "location": "ideal.html#Singular.ngens-Tuple{sideal}",
    "page": "Ideals",
...
{
    "location": "ideal.html#AbstractAlgebra.Generic.gens-Tuple{sideal}",
    "page": "Ideals",
...
{
    "location": "ideal.html#Base.iszero-Tuple{sideal}",
    "page": "Ideals",
    "title": "Base.iszero",
    "category": "method",
...
{
    "location": "ideal.html#Singular.iszerodim-Tuple{sideal}",
    "page": "Ideals",
...
{
    "location": "ideal.html#AbstractAlgebra.Generic.isconstant-Tuple{sideal}",
    "page": "Ideals",
...
{
    "location": "ideal.html#Singular.isvar_generated-Tuple{sideal}",
    "page": "Ideals",
...
{
    "location": "ideal.html#LinearAlgebra.normalize!-Tuple{sideal}",
    "page": "Ideals",
...

{
    ...
    "title": "Basic manipulation",
    "category": "section",
    "text": "ngens(::sideal)gens(::sideal)Singular.jl overloads the setindex! and getindex functions so that one can access the generators of an ideal using array notation.I[n::Int]iszero(::sideal)iszerodim(::sideal)isconstant(::sideal)isvar_generated(::sideal)normalize!(::sideal)ExamplesR, (x, y) = PolynomialRing(ZZ, [\"x\", \"y\"])\n\nI = Ideal(R, x^2 + 1, x*y)\n\nn = ngens(I)\np = I[1]\nI[1] = 2x + y^2\nisconstant(I) == false\nisvar_generated(I) == false\niszerodim(I) == false"
},

{
    "location": "ideal.html#Nemo.contains-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
    "title": "Nemo.contains",
    "category": "method",
...
{
    "location": "ideal.html#Base.isequal-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
    "title": "Base.isequal",
    "category": "method",
...
{
    "location": "ideal.html#Singular.equal-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
...
{
    "location": "ideal.html#Singular.intersection-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
...
{
    "location": "ideal.html#Singular.quotient-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
...
{
    "location": "ideal.html#Singular.lead-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.lead",
    "category": "method",
...
{
    "location": "ideal.html#Singular.saturation-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
...
{
    "location": "ideal.html#Statistics.std-Tuple{sideal}",
    "page": "Ideals",
...
{
    "location": "ideal.html#Singular.satstd-Union{Tuple{T}, Tuple{sideal{T},sideal{T}}} where T<:AbstractAlgebra.RingElem",
    "page": "Ideals",
...
{
    "location": "ideal.html#Base.reduce-Tuple{sideal,sideal}",
    "page": "Ideals",
    "title": "Base.reduce",
    "category": "method",
...
{
    "location": "ideal.html#Base.reduce-Tuple{spoly,sideal}",
    "page": "Ideals",
    "title": "Base.reduce",
    "category": "method",
...
{
    "location": "ideal.html#Singular.eliminate-Tuple{sideal,Vararg{spoly,N} where N}",
    "page": "Ideals",
...
{
    "location": "ideal.html#Singular.syz-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.syz",
    "category": "method",
...
{
    "location": "ideal.html#Singular.jet-Tuple{sideal,Int64}",
    "page": "Ideals",
    "title": "Singular.jet",
    "category": "method",
    "text": "jet(I::sideal, n::Int)\n\nGiven an ideal I this function truncates the generators of I up to degree n.\n\n\n\n"
},

{
    "location": "ideal.html#Singular.jacobi-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.jacobi",
    "category": "method",
    "text": "jacobi(I::sideal)\n\nGiven an ideal I this function computes the jacobi matrix of the generatos of I. The output is a matrix object.\n\n\n\n"
},

{
    "location": "ideal.html#Differential-operations-1",
    "page": "Ideals",
    "title": "Differential operations",
    "category": "section",
    "text": "jet(::sideal, ::Int)jacobi(::sideal)ExamplesR, (x, y, z) = PolynomialRing(QQ, [\"x\", \"y\", \"z\"])\n\nI = Ideal(R, x^5 - y^2, y^3 - x^6 + z^3)\n\nJ1 = jet(I, 3)\nJ2 = jacobi(I)"
},

{
    "location": "ideal.html#Singular.vdim-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.vdim",
    "category": "method",
    "text": "vdim(I::sideal)\n\nGiven a zero-dimensional ideal I this function computes the dimension of the vector space RI, where R is the polynomial ring over which I is an ideal. The ideal must be over a polynomial ring over a field, and a Groebner basis.\n\n\n\n"
},

{
    "location": "ideal.html#Singular.kbase-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.kbase",
    "category": "method",
    "text": "kbase(I::sideal)\n\nGiven a zero-dimensional ideal I this function computes a vector space basis of the vector space RI, where R is the polynomial ring over which I is an ideal. The ideal must be over a polynomial ring over a field, and a Groebner basis.\n\n\n\n"
},

{
    "location": "ideal.html#Singular.highcorner-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.highcorner",
    "category": "method",
    "text": "highcorner(I::sideal)\n\nGiven a zero-dimensional ideal I this function computes a The highest corner of I. The output is a polynomial. The ideal must be over a polynomial ring over a field, and a Groebner basis.\n\n\n\n"
},

{
    "location": "ideal.html#Operations-on-zero-dimensional-ideals-1",
    "page": "Ideals",
    "title": "Operations on zero-dimensional ideals",
    "category": "section",
    "text": "vdim(::sideal)kbase(::sideal)highcorner(::sideal)ExamplesR, (x, y) = PolynomialRing(QQ, [\"x\", \"y\"]; ordering=:negdegrevlex)\n\nI = Ideal(R, 3*x^2 + y^3, x*y^2)\n\nI = std(I)\n\nn = vdim(I)\nJ = kbase(I)\nf = highcorner(I)"
},

{
    "location": "ideal.html#Singular.minimal_generating_set-Tuple{sideal}",
    "page": "Ideals",
    "title": "Singular.minimal_generating_set",
    "category": "method",
    "text": "minimalgeneratingset(I::sideal)\n\nGiven an ideal I in ring R with local ordering, this returns an array containing the minimal generators of I.\n\n\n\n"
},

{
    "location": "ideal.html#Operations-over-local-rings-1",
    "page": "Ideals",
    "title": "Operations over local rings",
    "category": "section",
    "text": "If the base ring R is a local ring, a minimal generating set can be computed using the following functionminimal_generating_set(::sideal)ExamplesR, (x, y) = PolynomialRing(QQ, [\"x\", \"y\"]; ordering=:negdegrevlex)\n\nhas_local_ordering(R) == true\n\nI = Ideal(R, y, x^2, (1 + y^3) * (x^2 - y))\n\nmin = minimal_generating_set(I)"
},
...
{
    "location": "module.html#Singular.ngens-Tuple{smodule}",
    "page": "Finitely generated modules",
    "title": "Singular.ngens",
    "category": "method",
...
{
    "location": "module.html#LinearAlgebra.rank-Tuple{smodule}",
    "page": "Finitely generated modules",
...
{
    "location": "module.html#Base.iszero-Tuple{smodule}",
    "page": "Finitely generated modules",
    "title": "Base.iszero",
    "category": "method",
...
{
    "location": "module.html#Statistics.std-Tuple{smodule}",
    "page": "Finitely generated modules",
    "title": "Statistics.std",
    "category": "method",
...
{
    "location": "module.html#Singular.syz-Tuple{smodule}",
    "page": "Finitely generated modules",
    "title": "Singular.syz",
    "category": "method",
...
{
    "location": "module.html#Singular.sres-Union{Tuple{T}, Tuple{smodule{T},Int64}} where T<:AbstractAlgebra.RingElem",
    "page": "Finitely generated modules",
    "title": "Singular.sres",
    "category": "method",
...
{
    "location": "module.html#Singular.jet-Tuple{smodule,Int64}",
    "page": "Finitely generated modules",
    "title": "Singular.jet",
    "category": "method",
    "text": "jet(M::smodule, n::Int)\n\nGiven a module M this function truncates the generators of M up to degree n.\n\n\n\n"
},

{
    "location": "module.html#Jet-of-module-1",
    "page": "Finitely generated modules",
    "title": "Jet of module",
    "category": "section",
    "text": "jet(::smodule, ::Int)ExamplesR, (x, y) = PolynomialRing(QQ, [\"x\", \"y\"])\n\nv1 = vector(R, x + 1, x*y + 1, y)\nv2 = vector(R, x^5 + 1, 2x^3 + 3y^2, x^2)\n\nM = Singular.Module(R, v1, v2)\nN = jet(M,3)"
},

{
    "location": "module.html#Singular.minimal_generating_set-Tuple{smodule}",
    "page": "Finitely generated modules",
    "title": "Singular.minimal_generating_set",
    "category": "method",
    "text": "minimalgeneratingset(M::smodule)\n\nGiven a module M in ring R with local ordering, this returns an array containing the minimal generators of M.\n\n\n\n"
},

{
    "location": "module.html#Operations-over-local-rings-1",
    "page": "Finitely generated modules",
    "title": "Operations over local rings",
    "category": "section",
    "text": "If the base ring R is a local ring, a minimal generating set can be computed using the following functionminimal_generating_set(::smodule)ExamplesR, (x, y) = PolynomialRing(QQ, [\"x\", \"y\"]; ordering=:negdegrevlex)\n\nhas_local_ordering(R) == true\n\nv1 = vector(R, x, y^2)\nv2 = vector(R, y - x, y - y^2)\nv3 = v1 + v2\n\nM = Singular.Module(R, v1, v2, v3)\n   \nmin = minimal_generating_set(M)"
},
...
{
    "location": "vector.html#LinearAlgebra.rank-Tuple{FreeMod}",
    "page": "Free modules and vectors",
    "title": "LinearAlgebra.rank",
    "category": "method",
...
{
    "location": "vector.html#AbstractAlgebra.Generic.gens-Union{Tuple{FreeMod{T}}, Tuple{T}} where T<:AbstractAlgebra.RingElem",
    "page": "Free modules and vectors",
    "title": "AbstractAlgebra.Generic.gens",
    "category": "method",
...
{
    "location": "vector.html#Singular.jet-Union{Tuple{T}, Tuple{svector{spoly{T}},Int64}} where T<:AbstractAlgebra.RingElem",
    "page": "Free modules and vectors",
    "title": "Singular.jet",
    "category": "method",
    "text": "jet(x::svector{spoly{T}}, n::Int)\n\nGiven a vector x this function truncates each entry of x up to degree n.\n\n\n\n"
},

{
    "location": "vector.html#Jet-of-vectors-1",
    "page": "Free modules and vectors",
    "title": "Jet of vectors",
    "category": "section",
    "text": "jet{T <: AbstractAlgebra.RingElem}(::svector{spoly{T}}, ::Int)ExamplesR, (x, y) = PolynomialRing(QQ, [\"x\", \"y\"])\n\nv = vector(R, x^5 + 1, 2x^3 + 3y^2, x^2)\nw = jet(v, 3)"
},

{
    "location": "alghom.html#",
    "page": "Algebra Homomorphisms",
...
{
    "location": "alghom.html#Algebra-Homomorphisms-1",
    "page": "Algebra Homomorphisms",
    "title": "Algebra Homomorphisms",
    "category": "section",
    "text": "Singular.jl allows the creation of algebra homomorphisms of Singular polynomial rings over the fields QQ, Fp and finite extensions of Fp. The default algebra homomorphism type in Singular.jl is the Singular SAlgHom type.Additionally, a special type for the identity homomorphism has been implemented.  The type in Singular.jl for the latter is SIdAlgHom. All algebra homomorphism types belong directly to the abstract type AbstractAlgebraHomomorphism{T}."
},

{
    "location": "alghom.html#Algebra-Homomorphism-functionality-1",
    "page": "Algebra Homomorphisms",
    "title": "Algebra Homomorphism functionality",
    "category": "section",
    "text": ""
},

{
    "location": "alghom.html#Singular.AlgebraHomomorphism-Tuple{PolyRing,PolyRing,sideal}",
    "page": "Algebra Homomorphisms",
    "title": "Singular.AlgebraHomomorphism",
    "category": "method",
    "text": "Algebra_Homomorphism(D::PolyRing, C::PolyRing, I::sideal)\n\nConstructs an algebra homomorphism f D -- C, where the i-th variable of D is mapped to the i-th entry of I. D and C must be polynomial rings over the same base ring.\n\n\n\n"
},

{
    "location": "alghom.html#Singular.IdentityAlgebraHomomorphism-Tuple{PolyRing}",
    "page": "Algebra Homomorphisms",
    "title": "Singular.IdentityAlgebraHomomorphism",
    "category": "method",
    "text": "IdentityAlgebraHomomorphism(R::PolyRing)\n\nConstructs the canonical identity algebra homomorphism id D -- D, where the i-th variable of D is mapped to itself.\n\n\n\n"
},

{
    "location": "alghom.html#Constructors-1",
    "page": "Algebra Homomorphisms",
    "title": "Constructors",
    "category": "section",
    "text": "Given two Singular polynomial rings R and S over the same base field K, the following constructors are available for creating ideals.AlgebraHomomorphism(D::PolyRing, C::PolyRing, I::sideal)IdentityAlgebraHomomorphism(D::PolyRing)ExamplesL = FiniteField(3, 2, String(\"a\"))\n\nR, (x, y, z, w) = PolynomialRing(L[1], [\"x\", \"y\", \"z\", \"w\"];\n                             ordering=:negdegrevlex)\n\nS, (a, b, c) = PolynomialRing(L[1], [\"a\", \"b\", \"c\"];\n                             ordering=:degrevlex)\n\nI = Ideal(S, [a, a + b^2, b - c, c + b])\n\nf = AlgebraHomomorphism(R, S, I)"
},

{
    "location": "alghom.html#Operating-on-objects-1",
    "page": "Algebra Homomorphisms",
    "title": "Operating on objects",
    "category": "section",
    "text": "It is possible to act on polynomials and ideals via algebra homomorphisms. ExamplesR, (x, y, z, w) = PolynomialRing(Singular.Fp(3), [\"x\", \"y\", \"z\", \"w\"];\n                             ordering=:negdegrevlex)\n   \nS, (a, b, c) = PolynomialRing(Singular.Fp(3), [\"a\", \"b\", \"c\"];\n                             ordering=:degrevlex)\n   \nI = Ideal(S, [a, a + b^2, b - c, c + b])\n   \nf = AlgebraHomomorphism(R, S, I)\n   \nid  = IdentityAlgebraHomomorphism(S)\n\n   \nJ = Ideal(R, [x, y^3])\n   \np = x + y^3 + z*w\n\nK = f(J)\n\nq = f(p)"
},

{
    "location": "alghom.html#AbstractAlgebra.Generic.compose-Tuple{Singular.SAlgHom,Singular.SAlgHom}",
    "page": "Algebra Homomorphisms",
    "title": "AbstractAlgebra.Generic.compose",
    "category": "method",
    "text": "compose(f::AbstractAlgebra.Map(Singular.SAlgHom),                          g::AbstractAlgebra.Map(Singular.SAlgHom))\n\nReturns an algebra homomorphism h domain(f) -- codomain(g), where h = g(f).\n\n\n\n"
},

{
    "location": "alghom.html#Composition-1",
    "page": "Algebra Homomorphisms",
    "title": "Composition",
    "category": "section",
    "text": "compose(f::SAlgHom, g::SAlgHom)A short command for the composition of f and g is f*g, which is the same as compose(f, g).ExamplesR, (x, y, z, w) = PolynomialRing(Singular.QQ, [\"x\", \"y\", \"z\", \"w\"];\n                             ordering=:negdegrevlex)\n\nS, (a, b, c) = PolynomialRing(Singular.QQ, [\"a\", \"b\", \"c\"];\n                             ordering=:degrevlex)\n\nI = Ideal(S, [a, a + b^2, b - c, c + b])\n\nK = Ideal(R, [x^2, x + y + z, z*y])\n\nL = Ideal(R, [x^2, 2*x^2 + 2*x*y + y^2 + 2*x*z + 2*y*z + z^2, x + y + z - y*z,\n                x + y + z + y*z])\n\nf = AlgebraHomomorphism(R, S, I)\n\ng = AlgebraHomomorphism(S, R, K)\n\nidR  = IdentityAlgebraHomomorphism(R)\n\nh1 = f*g\n\nh2 = idR*f\n\nh3 = g*idR\n\nh4 = idR*idR"
},

{
    "location": "alghom.html#Singular.preimage-Tuple{Singular.SAlgHom,sideal}",
    "page": "Algebra Homomorphisms",
    "title": "Singular.preimage",
    "category": "method",
    "text": "preimage(f::AbstractAlgebra.Map(SAlgHom), I::sideal)\n\nReturns the preimage of the ideal I under the algebra homomorphism f.\n\n\n\n"
},

{
    "location": "alghom.html#Singular.kernel-Tuple{Singular.SAlgHom}",
    "page": "Algebra Homomorphisms",
    "title": "Singular.kernel",
    "category": "method",
    "text": "kernel(f::AbstractAlgebra.Map(SAlgHom))\n\nReturns the kernel of the algebra homomorphism f.\n\n\n\n"
},

{
    "location": "alghom.html#Preimages-1",
    "page": "Algebra Homomorphisms",
    "title": "Preimages",
    "category": "section",
    "text": "preimage(f::SAlgHom, I::sideal)kernel(f::SAlgHom)ExamplesR, (x, y, z, w) = PolynomialRing(QQ, [\"x\", \"y\", \"z\", \"w\"];\n                             ordering=:negdegrevlex)\n   \nS, (a, b, c) = PolynomialRing(QQ, [\"a\", \"b\", \"c\"];\n                             ordering=:degrevlex)\n   \nI = Ideal(S, [a, a + b^2, b - c, c + b])\n   \nf = SAlgebraHomomorphism(R, S, I)\n   \nidS  = IdentityAlgebraHomomorphism(S)\n\nP = preimage(f, I)\n\nK = kernel(f)"
},
...

{
    ...
    "title": "Constructors",
    "category": "section",
    "text": "There are currently two ways to create resolutions in Singular.jl: They can either be created by taking the free resolution of an ideal or module over a polynomial ring, as described in the relevant sections of the documentation, or they can be created by the following constructor:Resolution(::Array{smodule{T}, 1}) where T <: AbstractAlgebra.RingElemExampleR, (x, y) = PolynomialRing(QQ, [\"x\", \"y\"])\n\nM1 = Singular.Module(R, vector(R, x), vector(R, y))\nM2 = Singular.Module(R, vector(R, y, -x))\n\nF = Resolution([M1, M2])\nF[1]\nF[2]Alternatively, resolutions can be refined to minimal resolutions, as described below.Other than this, there are currently no additional ways to create resolutions in Singular.jl."
},

{
    "location": "resolution.html#Base.length-Tuple{sresolution}",
    "page": "Resolutions",
    "title": "Base.length",
    "category": "method",
...

{
    ...
    "title": "Basic manipulation",
    "category": "section",
    "text": "length(::sresolution)Singular.jl overloads the getindex function so that one can access the modules in a resolution F.F[n::Int]ExamplesR, (w, x, y, z) = PolynomialRing(QQ, [\"w\", \"x\", \"y\", \"z\"])\n\nI = Ideal(R, w^2 - x*z, w*x - y*z, x^2 - w*y, x*y - z^2, y^2 - w*z)\nF = fres(std(I), 0)\n\nn = length(F)\nM1 = F[1]"
},

{
    "location": "resolution.html#Singular.betti-Tuple{sresolution}",
    "page": "Resolutions",
...

{
    ...
    "title": "Betti numbers",
    "category": "section",
    "text": "betti(::sresolution)ExamplesR, (w, x, y, z) = PolynomialRing(QQ, [\"w\", \"x\", \"y\", \"z\"])\n\nI = Ideal(R, w^2 - x*z, w*x - y*z, x^2 - w*y, x*y - z^2, y^2 - w*z)\nF = fres(std(I), 3)\nM = minres(F)\n\nB = betti(M)"
},

{
    "location": "resolution.html#Singular.minres-Union{Tuple{sresolution{T}}, Tuple{T}} where T<:AbstractAlgebra.RingElem",
    "page": "Resolutions",
...

{
    ...
    "category": "section",
    "text": "minres{T <: AbstractAlgebra.RingElem}(::sresolution{T})ExamplesR, (w, x, y, z) = PolynomialRing(QQ, [\"w\", \"x\", \"y\", \"z\"])\n\nI = Ideal(R, w^2 - x*z, w*x - y*z, x^2 - w*y, x*y - z^2, y^2 - w*z)\nF = fres(std(I), 3)\nM = minres(F)"
},
